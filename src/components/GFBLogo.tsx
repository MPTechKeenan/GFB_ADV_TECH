...
export default function GFBLogo({
  ...
  const stroke = light ? WHITE : CYAN;
  const fill = light ? WHITE : CYAN;
  const glow = light ? WHITE : CYAN;
  const wordmarkFill = WHITE_SOFT;
  const taglineFill = light ? SLATE_LIGHT : SLATE;
  ...
  if (iconOnly) {
    return (
      ...
      >
        ...
        <line x1="50" y1="39.5" x2="32" y2="32" stroke={stroke} strokeWidth="0.8" opacity={0.2} />
        <line x1="14" y1="39.5" x2="32" y2="32" stroke={stroke} strokeWidth="0.8" opacity={0.2} />
        <line x1="32" y1="50" x2="32" y2="32" stroke={stroke} strokeWidth="0.8" opacity={0.25} />
        <circle cx="32" cy="14" r="2" fill={fill} />
        <circle cx="50" cy="24.5" r="1.6" fill={fill} opacity={0.65} />
        <circle cx="50" cy="39.5" r="1.6" fill={fill} opacity={0.65} />
        <circle cx="32" cy="50" r="1.6" fill={fill} opacity={0.65} />
        <circle cx="14" cy="39.5" r="1.6" fill={fill} opacity={0.65} />
        <circle cx="14" cy="24.5" r="1.6" fill={fill} opacity={0.65} />
        <circle cx="32" cy="32" r="5.5" fill={`url(#${id}-coreGlow)`} />
        <circle cx="32" cy="32" r="2.5" fill={fill} />
        <circle cx="32" cy="32" r="1" fill={light ? WHITE_SOFT : "#e0f9ff"} />
      </svg>
    );
  }
    ...
    >
      <defs>
        ...
        <radialGradient id={`${id}-coreGlow`} cx="50%" cy="50%" r="50%">
          <stop offset="0%" stopColor={glow} stopOpacity={1} />
          <stop offset="60%" stopColor={glow} stopOpacity={0.6} />
          <stop offset="100%" stopColor={glow} stopOpacity={0} />
        </radialGradient>
      ...
      <line x1="50" y1="39.5" x2="32" y2="32" stroke={stroke} strokeWidth="0.7" opacity={0.25} />
      <line x1="14" y1="39.5" x2="32" y2="32" stroke={stroke} strokeWidth="0.7" opacity={0.25} />
      <line x1="32" y1="50" x2="32" y2="32" stroke={stroke} strokeWidth="0.7" opacity={0.3} />
      <circle cx="32" cy="14" r="1.6" fill={fill} opacity={0.9} />
      <circle cx="50" cy="24.5" r="1.6" fill={fill} opacity={0.6} />
      <circle cx="50" cy="39.5" r="1.6" fill={fill} opacity={0.6} />
      <circle cx="32" cy="50" r="1.6" fill={fill} opacity={0.6} />
      <circle cx="14" cy="39.5" r="1.6" fill={fill} opacity={0.6} />
      <circle cx="14" cy="24.5" r="1.6" fill={fill} opacity={0.6} />
